...
class myPose():
    def __init__(self):
        ...
        # Luu lai cai vi tri 2 vai cua nguoi dung khi vo tay bat dau game
    ...
    def checkPose_LRC(self, image, results):
        ...
        cv2.putText(image, LRC, (5, image_height - 10),
                    cv2.FONT_HERSHEY_PLAIN, 2, (255, 255, 255), 3)
        cv2.line(image, (image_mid_width, 0),
                 (image_mid_width, image_height), (255, 255, 255), 2)
    ...
    def checkPose_JSD(self, image, results):
        ...
        leftShoulder_y = int(
            results.pose_landmarks.landmark[self.mp_pose.PoseLandmark.LEFT_SHOULDER].y * image_height)
        rightShoulder_y = int(
        ...
        cv2.putText(image, JSD, (5, image_height - 50),
                    cv2.FONT_HERSHEY_PLAIN, 2, (0, 255, 255), 3)
        cv2.line(image, (0, self.shoudler_line_y),
                 (image_width, self.shoudler_line_y), (0, 255, 255), 2)
    ...
    def checkPose_Clap(self, image, results):
        ...
        distance = int(math.hypot(
            left_hand[0] - right_hand[0], left_hand[1] - right_hand[1]))
